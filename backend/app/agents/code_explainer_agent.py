...
SYSTEM_PROMPT = """Given a piece of code, explain what it does and how it works."""


class CodeExplainerAgent(BaseAgent):
    """Explains code written by a code generator"""
    ...
    async def execute(
        ...
        logger.info("[CodeExplainerAgent] processing query (len=%d)", len(query))
        self.ensure_loaded()
        context = context or {}
        ...
        with Timer() as t:
            ...
            try:
                ...
                logger.exception("[CodeExplainerAgent] generation failed")
                return AgentResult(
