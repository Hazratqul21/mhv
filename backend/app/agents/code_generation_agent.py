...
SYSTEM_PROMPT = """Given a task such as 'Write code: print hello', generate the code to perform the task"""


class CodeGenerationAgent(BaseAgent):
    """Generates code to perform tasks such as printing messages"""
    ...
    async def execute(
        ...
        logger.info("[CodeGenerationAgent] processing query (len=%d)", len(query))
        self.ensure_loaded()
        context = context or {}
        ...
        with Timer() as t:
            ...
            try:
                ...
                logger.exception("[CodeGenerationAgent] generation failed")
                return AgentResult(
