...
SYSTEM_PROMPT = """Given a simple task, generate the code to perform it."""


class CodeGeneratorAgent(BaseAgent):
    """Generates code for simple tasks"""
    ...
    async def execute(
        ...
        logger.info("[CodeGeneratorAgent] processing query (len=%d)", len(query))
        self.ensure_loaded()
        context = context or {}
        ...
        with Timer() as t:
            ...
            try:
                ...
                logger.exception("[CodeGeneratorAgent] generation failed")
                return AgentResult(
