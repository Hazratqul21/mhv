...
SYSTEM_PROMPT = """Given a programming question, explain the steps to write the code in a simple and easy-to-understand manner."""


class CodeTutorialAgent(BaseAgent):
    """Provides code tutorials for beginners"""
    ...
    async def execute(
        ...
        logger.info("[CodeTutorialAgent] processing query (len=%d)", len(query))
        self.ensure_loaded()
        context = context or {}
        ...
        with Timer() as t:
            ...
            try:
                ...
                logger.exception("[CodeTutorialAgent] generation failed")
                return AgentResult(
